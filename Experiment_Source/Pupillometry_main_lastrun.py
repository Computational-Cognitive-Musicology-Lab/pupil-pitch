...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/cmml/github/pupil-pitch/Experiment_Source/Pupillometry_main_lastrun.py',
...
button = visual.ButtonStim(win, 
    text='Press Space to Consent', font='Arvo',
    pos=(0,-0.4),
    letterHeight=0.05,
...
text_7 = visual.TextStim(win=win, name='text_7',
    text='This experiment requires you to wear headphones. The experimenters have carefully calibrated the volume so as to be the same for all participants. Kindly do not adjust volume.\nIn this study your task is to compare the height of two tones, and respond indicating whether you\n think the second tone of the pair was higher or lower than the first. You will indicate whether you\n thought the tone was lower or higher using the left and right [SHIFT] keys. This is a purely aural task\n and there will be no visual information.\n For each trial (task) you will actually hear a total of 4 tones: first a “ready” tone which alerts you that\n the trial is beginning; then you will hear the comparison tone (which is always the same); then you\n will hear your comparison tone (the one that varies); finally, you will hear a “respond” tone at which\n point you may enter one of the [SHIFT] keys to indicate your response. Note that is it very\n important you wait for the “response” tone before entering your response. After you have\n entered your response, you will hear a “buzz” or “ding” sound to alert you to whether your response\n was incorrect or correct, respectively. An illustration of the trial design is shown below.',
    font='Open Sans',
    pos=(0, 0.20), height=0.0225, wrapWidth=None, ori=0.0, 
    color='white', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
    depth=0.0);
...
text_10 = visual.TextStim(win=win, name='text_10',
    text=' You will perform this task in a block of 11 trials, following which you will see a screen that will indicate that the block is over, and you may press the [SPACE] key whenever you are ready to\n continue to the next block. There are a total of 5 blocks (and a total of 55 trials).\n A fixation cross will appear on the screen and we ask that you maintain your gaze on the cross for\n the duration of the experiment as much as possible. In between blocks you will see a message that it is a good time to take a break for your eyes if you need to. You do not have to worry about blinking.\nPress space to continue!\n',
    font='Open Sans',
    pos=(0, -0.25), height=0.0225, wrapWidth=None, ori=0.0, 
    color='white', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
    depth=-3.0);
image = visual.ImageStim(
    win=win,
    name='image', 
    image='/Users/cmml/Downloads/LaTeX_DL_468198_240419/TrialDiagram2.png', mask=None, anchor='center',
    ori=0.0, pos=(0, -0.075), size=(0.5, 0.125),
...
# keep track of which components have finished
Intro_contdComponents = [text_7, key_resp_8, sound_31, text_10, image]
...
continueRoutine = True
# update component parameters for each repeat
text.setText('That concludes the practice block.\nYou can take some time to look away from the screen and relax your eyes.\n\nPlease press Spacebar to continue with the experiment.\n')
key_resp_2.keys = []
key_resp_2.rt = []
_key_resp_2_allKeys = []
# keep track of which components have finished
...
for thisTrial in trials:
    ...
    if eyetracking == '1':    
        time_fn = core.monotonicClock.getTime
        name = expInfo['participant']
        rstring ='R '+ str(name)+str(block_check)
...
# set up handler to look after randomisation of conditions etc
trials_2 = data.TrialHandler(nReps=11.0, method='sequential', 
    extraInfo=expInfo, originPath=-1,
    trialList=[None],
...
# completed 11.0 repeats of 'trials_2'
...
# set up handler to look after randomisation of conditions etc
trials_3 = data.TrialHandler(nReps=11.0, method='sequential', 
    extraInfo=expInfo, originPath=-1,
    trialList=[None],
...
# completed 11.0 repeats of 'trials_3'
...
# set up handler to look after randomisation of conditions etc
trials_4 = data.TrialHandler(nReps=11.0, method='sequential', 
    extraInfo=expInfo, originPath=-1,
    trialList=[None],
...
# completed 11.0 repeats of 'trials_4'
...
# set up handler to look after randomisation of conditions etc
trials_5 = data.TrialHandler(nReps=11.0, method='sequential', 
    extraInfo=expInfo, originPath=-1,
    trialList=[None],
...
# completed 11.0 repeats of 'trials_5'
