...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/cmml/github/pupil-pitch/Experiment_Source/Pupillometry_main.py',
...
# keep track of which components have finished
IntroductionComponents = [text_6, button_2, key_resp_11, image]
