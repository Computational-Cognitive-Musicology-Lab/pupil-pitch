...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/cmml/github/pupil-pitch/Experiment_Source/Pupillometry_variation_lastrun.py',
...
text_7 = visual.TextStim(win=win, name='text_7',
    text='This experiment requires you to wear headphones. The experimenters have carefully calibrated the volume so as to be the same for all participants. Kindly do not adjust volume. \n\xa0\nIn this study your task is to compare the height of two tones, and respond indicating whether you think the second tone of the pair was higher or lower than the first. You will indicate whether you thought the tone was lower or higher using the left and right [SHIFT] keys. This is a purely aural task and there will be no visual information.\n\xa0\nFor each trial (task) you will actually hear a total of 4 tones: first a “ready” tone which alerts you that the trial is beginning; then you will hear the comparison tone (which is always the same); then you will hear your comparison tone (the one that varies); finally, you will hear a “respond” tone at which point you may enter one of the [SHIFT] keys to indicate your response.\xa0 Note that is it very important you wait for the “response” tone before entering your response. After you have entered your response, you will hear a “buzz” or “ding” sound to alert you to whether your response was incorrect or correct, respectively. An illustration of the trial design is shown below.\n',
    font='Open Sans',
...
text_10 = visual.TextStim(win=win, name='text_10',
    text='You will perform this task in a block of 11 trials, following which you will see a screen that will indicate that the block is over, and you may press the [SPACE] key whenever you are ready to continue to the next block. There are a total of 5 blocks (and a total of 55 trials).\n\xa0\nA fixation cross will appear on the screen and we ask that you maintain your gaze on the cross for the duration of the experiment as much as possible. In between blocks you will see a message that it is a good time to take a break for your eyes if you need to. You do not have to worry about blinking your eyes.\n\nPress spacebar to begin the practice trials\n\n',
    font='Open Sans',
    pos=(0, -0.25), height=0.02, wrapWidth=None, ori=0.0, 
    color='white', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
...
image = visual.ImageStim(
    win=win,
    name='image', units='cm', 
    image='/Users/cmml/github/pupil-pitch/images/TrialDiagram.png', mask=None, anchor='center',
    ori=0.0, pos=(0, -2), size=(22, 8),
...
while continueRoutine:
    ...
    # *key_resp_11* updates
    waitOnFlip = False
    if key_resp_11.status == NOT_STARTED and tThisFlip >= 2.0-frameTolerance:
        # keep track of start time/frame for later
...
while continueRoutine:
    ...
    # *key_resp_12* updates
    waitOnFlip = False
    if key_resp_12.status == NOT_STARTED and tThisFlip >= 2.0-frameTolerance:
        # keep track of start time/frame for later
...
for thisTrial in trials:
    ...
    if (key_resp.corr):
        ...
        if(find_it==1):
            ...
            sound = sounds[1]
    next_wait = np.random.choice(np.arange(3,7),1)[0]
    time_fn = core.monotonicClock.getTime
    label = "feedback_tone"
    duration = 0.
    minimal_trigger = new_trigger(label, duration)
